// src/lib.rs
/*
 * Core library for MonitoringDash
 */
...
#[derive(Debug)]
pub struct MonitoringDashProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MonitoringDashProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MonitoringDash processing");
    
    let mut processor = MonitoringDashProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MonitoringDashProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MonitoringDashProcessor::new(false);
